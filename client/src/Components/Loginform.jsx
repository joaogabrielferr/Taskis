    ...
    return (
        <div className = "loginform">
            ...
            <input type="text" placeholder = "Username" className = "inputlogin" onChange = {(e)=>setUsername(e.target.value)}/>
             ...
             <div id = "loginbuttons"><button onClick = {()=>login(username,password)} className = "botaodelogin">Login</button><p>&nbsp;</p>   <p>&nbsp;</p>   <p>&nbsp;</p>   <button onClick = {()=>{setMostraloginform(false);setPesquisoulogin(false);}} className ="botaodecancelar">Cancel</button></div>
             </div>
        </div>
    )
}
