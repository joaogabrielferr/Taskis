    ...
    return (
        <div className = "loginform">
            ...
            <input type="text" placeholder = "Username" className = "inputlogin" onChange = {(e)=>setUsername(e.target.value)}/>
             ...
             <div className = "loginbuttons"><button onClick = {()=>register(username,password)} className = "botaodelogin">Register</button><button onClick = {()=>{setMostraloginreg(false);setPesquisouregister(false);}} className ="botaodecancelar">Cancel</button></div>
             </div>
        </div>
    )
}
